...
const SearchNewsPage = () => {
    ...
    async function handleSubmit(e: FormEvent<HTMLFormElement>) {
        // We don't use react-form-hook here because there is only one input field.
        e.preventDefault();
    ...
    return (
        <>
            <Head>
                <title key="title">Search News -- NextJS tutorial</title>
            </Head>
            <main>
                <h1>Search News</h1>
                <Alert>
                ...
                <div className="d-flex flex-column align-items-center">
                    ...
                    {searchResultsLoadingIsError && <p>Failed to load search results</p>}
